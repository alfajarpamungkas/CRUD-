                        ...
                        <div class="card-body">
                            <form action="{{ route('article.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Slug" required value="{{$data->slug}}">
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="content" class="form-control" placeholder="Content" required >{{$data->content}}"</textarea>
                                </div>
