...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mt-5 mb-5">Edit Category</h1>
                ...
                <div class="card-body">
                    <form action="/updatecategory/{{ $data->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="emailHelp" class="form-text">Hahhhhhhhhh</div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Slug</label>
                            <input type="text" name="slug" class="form-control" id="exampleInputPassword1" value="{{ $data->slug}}">
                        </div>
                        <div class="mb-3">
